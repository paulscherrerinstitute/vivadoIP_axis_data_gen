...
For details, refer to the [Datasheet](doc/axis_data_gen.pdf)
...
* VivadoIp
  * [**vivadoIP\_axis\_data\_gen**](https://github.com/paulscherrerinstitute/vivadoIP_axis_data_gen)
...
# Description
This IP-core implements a simple AXI-stream data generator.

Main features are:
* Generates counter data
* Generates trigger/TLAST
* Data- and Trigger-rate configurable
* Can operated independently (without configuration by SW) after reset
